...
export async function GET() {
  ...
  const [
    ...
    supabase.from('users').select('id,name,username,mvps,batting_style,bowling_style,player_role,batting_position,jersey_number,bio,preferred_ground,date_of_birth,created_at,matches_played,matches_won,matches_lost,matches_tied,mvps').eq('id', session.id).single(),
